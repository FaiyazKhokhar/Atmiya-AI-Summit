...
import { User, Check, Edit2, Loader2, Save, Camera } from 'lucide-react';
...
export default function WorkerProfile() {
    ...
    useEffect(() => {
        ...
        if (storedProfile) {
            ...
            const savedPic = localStorage.getItem(`workerProfilePic_${id}`);
            if (savedPic) {
    ...
    const handleProfilePictureChange = (e) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                ...
                localStorage.setItem(`workerProfilePic_${profile.id}`, base64String);
    ...
    const handleUpdate = async (e) => {
        ...
        setSaving(true);
        try {
            const response = await fetch(`/api/workers/${profile.id}`, {
                method: 'PUT',
        ...
        return (
            <div className="p-8 text-center container">
                <Card>
                    ...
                    <p className="mb-4">Please register to create a worker profile.</p>
                    <Button onClick={() => navigate('/worker/register')}>Register Now</Button>
                </Card>
            </div>
        );
    }
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-secondary text-sm">Worker Profile</p>
                            </div>
                        </div>
                        {!isEditing && (
